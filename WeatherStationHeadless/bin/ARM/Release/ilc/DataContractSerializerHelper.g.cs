...
namespace System.Runtime.Serialization.Generated
{
    ...
    public static partial class DataContractSerializerHelper
    {
        ...
        static int[] s_xmlDictionaryStrings = new int[] {
                ...
                -1, // string: null
                -1, // string: null
                345, // index: 345, string: "http://schemas.datacontract.org/2004/07/System"
                -1, // string: null
                -1, // string: null
                1, // array length: 1
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/WeatherStationHeadless"
                11, // array length: 11
                465, // index: 465, string: "Altitude"
                474, // index: 474, string: "BarometricPressure"
                493, // index: 493, string: "CelsiusTemperature"
                512, // index: 512, string: "FahrenheitTemperature"
                534, // index: 534, string: "Humidity"
                543, // index: 543, string: "LightSensorVoltage"
                562, // index: 562, string: "PeakWindSpeed"
                576, // index: 576, string: "RainFall"
                585, // index: 585, string: "TimeStamp"
                595, // index: 595, string: "WindDirection"
                609, // index: 609, string: "WindSpeed"
                11, // array length: 11
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/WeatherStationHeadless"
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/WeatherStationHeadless"
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/WeatherStationHeadless"
                ...
                345, // index: 345, string: "http://schemas.datacontract.org/2004/07/System"
                2, // array length: 2
                619, // index: 619, string: "DateTime"
                628, // index: 628, string: "OffsetMinutes"
                2, // array length: 2
                345, // index: 345, string: "http://schemas.datacontract.org/2004/07/System"
                345  // index: 345, string: "http://schemas.datacontract.org/2004/07/System"
        };
        ...
        static readonly global::DataContractMapEntry[] s_dataContractMap = new global::DataContractMapEntry[] {
                ...
                new global::DataContractMapEntry() {
                    UserCodeType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("WeatherStationHeadless.WeatherData, WeatherStationHeadless, Version=1.0.0.0, Culture=neutral, PublicKeyToken=nul" +
                                "l")),
                    TableIndex = 1, // 0x1
                }, 
                new global::DataContractMapEntry() {
        ...
        static readonly global::ClassDataContractEntry[] s_classDataContracts = new global::ClassDataContractEntry[] {
                new global::ClassDataContractEntry() {
                    Common = new global::CommonContractEntry() {
                        HasRoot = true,
                        NameIndex = 255, // WeatherData
                        NamespaceIndex = 267, // http://schemas.datacontract.org/2004/07/WeatherStationHeadless
                        StableNameIndex = 255, // WeatherData
                        StableNameNamespaceIndex = 267, // http://schemas.datacontract.org/2004/07/WeatherStationHeadless
                        TopLevelElementNameIndex = 255, // WeatherData
                        TopLevelElementNamespaceIndex = 267, // http://schemas.datacontract.org/2004/07/WeatherStationHeadless
                        OriginalUnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("WeatherStationHeadless.WeatherData, WeatherStationHeadless, Version=1.0.0.0, Culture=neutral, PublicKeyToken=nul" +
                                    "l")),
                        UnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("WeatherStationHeadless.WeatherData, WeatherStationHeadless, Version=1.0.0.0, Culture=neutral, PublicKeyToken=nul" +
                                    "l")),
                    },
                ...
                new global::ClassDataContractEntry() {
                    Common = new global::CommonContractEntry() {
                        HasRoot = true,
                        IsValueType = true,
                        NameIndex = 330, // DateTimeOffset
                        NamespaceIndex = 345, // http://schemas.datacontract.org/2004/07/System
                        StableNameIndex = 330, // DateTimeOffset
                        StableNameNamespaceIndex = 345, // http://schemas.datacontract.org/2004/07/System
                        TopLevelElementNameIndex = 330, // DateTimeOffset
                        TopLevelElementNamespaceIndex = 345, // http://schemas.datacontract.org/2004/07/System
        ...
        static readonly global::CollectionDataContractEntry[] s_collectionDataContracts = new global::CollectionDataContractEntry[] {
                new global::CollectionDataContractEntry() {
                    Common = new global::CommonContractEntry() {
                        HasRoot = true,
                        NameIndex = 392, // ArrayOfanyType
                        NamespaceIndex = 407, // http://schemas.microsoft.com/2003/10/Serialization/Arrays
                        StableNameIndex = 392, // ArrayOfanyType
                        StableNameNamespaceIndex = 407, // http://schemas.microsoft.com/2003/10/Serialization/Arrays
                        TopLevelElementNameIndex = 392, // ArrayOfanyType
                        TopLevelElementNamespaceIndex = 407, // http://schemas.microsoft.com/2003/10/Serialization/Arrays
                        OriginalUnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("System.Object[], System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")),
                        UnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("System.Object[], System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")),
                    },
        ...
        static readonly global::JsonDelegateEntry[] s_jsonDelegatesList = new global::JsonDelegateEntry[] {
                new global::JsonDelegateEntry() {
                    ...
                    WriterDelegate = global::SgIntrinsics.AddrOf<global::System.Runtime.Serialization.Json.JsonFormatClassWriterDelegate>(global::Type3.WriteWeatherDataToJson),
                    ReaderDelegate = global::SgIntrinsics.AddrOf<global::System.Runtime.Serialization.Json.JsonFormatClassReaderDelegate>(global::Type2.ReadWeatherDataFromJson),
                }, 
                new global::JsonDelegateEntry() {
        ...
        static char[] s_stringPool = new char[] {
            ...
            'e','d','S','h','o','r','t','\0','a','n','y','U','R','I','\0','W','e','a','t','h','e','r','D','a','t','a','\0','h','t','t',
            'p',':','/','/','s','c','h','e','m','a','s','.','d','a','t','a','c','o','n','t','r','a','c','t','.','o','r','g','/','2',
            '0','0','4','/','0','7','/','W','e','a','t','h','e','r','S','t','a','t','i','o','n','H','e','a','d','l','e','s','s','\0',
            'D','a','t','e','T','i','m','e','O','f','f','s','e','t','\0','h','t','t','p',':','/','/','s','c','h','e','m','a','s','.',
            'd','a','t','a','c','o','n','t','r','a','c','t','.','o','r','g','/','2','0','0','4','/','0','7','/','S','y','s','t','e',
            'm','\0','A','r','r','a','y','O','f','a','n','y','T','y','p','e','\0','h','t','t','p',':','/','/','s','c','h','e','m','a',
            's','.','m','i','c','r','o','s','o','f','t','.','c','o','m','/','2','0','0','3','/','1','0','/','S','e','r','i','a','l',
            'i','z','a','t','i','o','n','/','A','r','r','a','y','s','\0','A','l','t','i','t','u','d','e','\0','B','a','r','o','m','e',
            't','r','i','c','P','r','e','s','s','u','r','e','\0','C','e','l','s','i','u','s','T','e','m','p','e','r','a','t','u','r',
            'e','\0','F','a','h','r','e','n','h','e','i','t','T','e','m','p','e','r','a','t','u','r','e','\0','H','u','m','i','d','i',
            't','y','\0','L','i','g','h','t','S','e','n','s','o','r','V','o','l','t','a','g','e','\0','P','e','a','k','W','i','n','d',
            'S','p','e','e','d','\0','R','a','i','n','F','a','l','l','\0','T','i','m','e','S','t','a','m','p','\0','W','i','n','d','D',
            'i','r','e','c','t','i','o','n','\0','W','i','n','d','S','p','e','e','d','\0','D','a','t','e','T','i','m','e','\0','O','f',
            'f','s','e','t','M','i','n','u','t','e','s','\0'};
    }
}
